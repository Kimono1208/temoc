            ...
            <div class="row">
              ...
              <div class="col-4 text-end">
                <div class="icon icon-shape bg-gradient-danger shadow-danger text-center rounded-circle">
                  <a href="/admin/proveedores/create"><i class="ni ni-world text-lg opacity-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-4 text-end">
                <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                  <a href="/admin/llantas/create"><i class="ni ni-paper-diploma text-lg opacity-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-4 text-end">
                <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                 <a href="/admin/rines/create"> <i class="ni ni-cart text-lg opacity-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-body p-3">
            <div class="row">
              ...
              <div class="col-4 text-end">
                <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                 <a href="/admin/venta/create"> <i class="ni ni-cart text-lg opacity-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-body p-3">
            <div class="row">
              ...
              <div class="col-4 text-end">
                <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                 <a href="/admin/llantas/data"> <i class="ni ni-cart text-lg opacity-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-7 mb-lg-0 mb-4 w-100">
        <div class="card z-index-2 h-100">
          <div class="card-header pb-0 pt-3 bg-transparent">
            <h6 class="text-capitalize">Ventas del mes</h6>
            <p class="text-sm mb-0">
              <i class="fa fa-arrow-up text-success"></i>
              <span class="font-weight-bold">4% más</span> que en 2023
            </p>
          </div>
          <div class="card-body p-3">
            <div class="chart">
