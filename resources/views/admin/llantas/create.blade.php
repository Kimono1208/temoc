                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="row g-3 needs-validation" novalidate method="POST" action="/llantas"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-4">
                                    <label for="validationCustom02" class="form-label">Marca</label>
                                    <input type="text" class="form-control" id="validationCustom02" name="marca"
                                        required>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" name="ancho"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom04" name="alto"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom05" name="rin"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom06" name="indice_carga"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="any" class="form-control" id="validationCustom08"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="any" class="form-control" id="validationCustom09"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="any" class="form-control" id="validationCustom10"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="validationCustom11" name="fecha"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom12" name="costo"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    <label for="validationCustom12" class="form-label">Cantidad ingresada</label>
                                    <input type="number" class="form-control" id="validationCustom12" name="cantidad"
                                        required>
                                    <div class="invalid-feedback">
                                        Por favor registra las unidades ingresadas
                                    </div>
                                </div>
                                <div class="col-md-4">
